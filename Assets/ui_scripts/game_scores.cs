...
public class game_scores : MonoBehaviour {
	...
	void OnGUI () {
		...
		GUI.Box(new Rect(10,Screen.height - 50 , 100, 50), "Scores");
		...
		//label username
		GUI.Label(new Rect(11, Screen.height - 40, 80, 20), player_info.instance._name + ": " + player_info.instance._score as string);
